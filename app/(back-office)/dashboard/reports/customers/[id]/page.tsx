import { getOrderReportByCustomerId } from "@/actions/orders";
...
export default async function page({params, searchParams}: Props) {
  ...
  const data = await getOrderReportByCustomerId(orderId, Number(page), pageSize);
  // Create function that fetches products by catSlug,type
  const orders = data?.orders || [] as ILineOrder[];
