...
import ReviewApproveBtn from "@/components/dashboard/ReviewApproveBtn";
...
export default async function page({params}: Props) {
  ...
  const productReviews = (await getProductReviews(product?.id ?? 0)) || [];
        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-8">
          <div className="col-span-full md:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="">
              ...
              <div className="py-4">
                {/* Add to Cart */}
                <AddToCartButton product={product as IProducts} />
              </div>
